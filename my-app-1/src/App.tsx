...
// 1.обложка карточки div. Закругление границы 20px +; наличие тени по всем сторонам.
...
// 6.See more будет синий с прозрачным текстом, без бордера, закругленные концы 5px - 10px
// 7.Save будет с синим бордером и текстом, но с прозрачным фоном.